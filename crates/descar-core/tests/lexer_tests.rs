...
fn number_edge_cases() {
    ...
    assert_eq!(
        errors[0].to_string(),
        "[E0010] Number literal overflow: \"#b1111111111111111111111111111111111111111111111111111111111111111\" at test:line 1:column 1-line 1:column 67\nhelp: Use a smaller value or a compatible type."
    );
}
...
fn invalid_tokens() {
    let cases = vec![
        ("@", "[E0001] Invalid or unrecognized token: \"@\" at test:line 1:column 1-line 1:column 2"),
        ("`", "[E0001] Invalid or unrecognized token: \"`\" at test:line 1:column 1-line 1:column 2"),
    ];
...
fn iterator_multiple_invalid_tokens() {
    ...
    assert_eq!(
        errors[1].to_string(),
        "[E0001] Invalid or unrecognized token: \"$\" at test:line 1:column 3-line 1:column 4"
    );
}
...
fn iterator_multiline_span_tracking() {
    ...
    assert_eq!(
        errors[0].to_string(),
        "[E0001] Invalid or unrecognized token: \"@\" at test:line 2:column 1-line 2:column 2"
    );
}
