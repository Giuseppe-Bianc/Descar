...
///
/// ```
/// use descar_core::tokens::parsers::suffix::check_single_char_suffix;
...
#[inline]
#[must_use]
pub const fn check_single_char_suffix(bytes: &[u8]) -> Option<SuffixPattern> {
    if bytes.is_empty() {
        return None;
    }
...
///
/// ```
/// use descar_core::tokens::parsers::suffix::check_three_char_suffix;
...
///
/// ```
/// use descar_core::tokens::parsers::suffix::check_two_char_suffix;
...
///
/// ```
/// use descar_core::tokens::parsers::suffix::split_numeric_and_suffix;
///
...
///
/// ```
/// use descar_core::tokens::parsers::suffix::handle_suffix;
